...
export function ensureAgendaEventDefaults(meeting: Meeting): Meeting {
  ...
  return {
    ...
    manualFinalizationAction: meeting.manualFinalizationAction || null,
    saleValueCents: Number.isFinite(meeting.saleValueCents) ? Number(meeting.saleValueCents) : null,
    convertedToCustomerAt: meeting.convertedToCustomerAt || null,
    createdAt,
    updatedAt,
